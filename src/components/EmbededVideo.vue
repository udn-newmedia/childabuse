    ...
    <div class="videocontainer">
        <div class="video-contain" :style="{backgroundColor: backgroundColor}">
            <video preload="metadata" playsinline
                   ...
                   @click='handle_clickVideo' @playing="getPlayingProgress" ref='video'></video>
            <div class="video-control">
              ...
              <i class="fa volume hidden-lg" :style="{color: controlColor}"
...
export default {
  name: 'embededvideo',
  props: ['src', 'srcWeb', 'poster', 'posterWeb', 'backgroundColor', 'customControl', 'controlColor'],
  components: {
  },
  data: function () {
    return {
